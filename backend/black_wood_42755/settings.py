"""
Django settings for black_wood_42755 project.
...
ROOT_URLCONF = 'black_wood_42755.urls'
...
WSGI_APPLICATION = 'black_wood_42755.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_wood_42755 API",
    "DESCRIPTION": "API documentation for black_wood_42755 App",
    "VERSION": "v1",
}
